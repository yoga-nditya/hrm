                    ...
                    <div class="row">
                            ...
                            <div class="card bg-light mb-3">
                                <div class="card-body">
                                    ...
                                    <ul class="list-unstyled">
                                        @if($userDetail && $userDetail->no_telpon)
                                            <li class="mb-2">
                                                <i class="fas fa-phone me-2 text-primary"></i>
                                                {{ $userDetail->no_telpon }}
                                            </li>
                                        @endif
                                        @if($userDetail && $userDetail->alamat)
                                            <li class="mb-2">
                                                <i class="fas fa-map-marker-alt me-2 text-primary"></i>
                                                {{ $userDetail->alamat }}
                                            </li>
                                            <li class="mb-2 ps-4">
                                                {{ $userDetail->kota }}, {{ $userDetail->provinsi }} {{ $userDetail->kode_pos }}
                                            </li>
                                        @endif
                                    </ul>
                                </div>
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="mb-4">
                                ...
                                @if($pengalaman && $pengalaman->pengalaman_kerja)
                                    <div class="ps-3">
                            ...
                            <div class="mb-4">
                                ...
                                @if($pengalaman && $pengalaman->pendidikan)
                                    <div class="ps-3">
                            ...
                            <div class="mb-4">
                                ...
                                @if($pengalaman && $pengalaman->pengalaman_organisasi)
                                    <div class="ps-3">
                            ...
                            <div class="mb-4">
                                ...
                                @if($pengalaman && $pengalaman->pengalaman_sertifikasi_pelatihan)
                                    <div class="ps-3">
